...
protocol ServiceProtocol {
    func getRecipe(searchText: String, onSuccess: @escaping (RecipeApi?) -> Void, onError: @escaping (AFError) -> Void)
}

final class Service: ServiceProtocol {
    func getRecipe(searchText: String, onSuccess: @escaping (RecipeApi?) -> Void, onError: @escaping (Alamofire.AFError) -> Void) {
